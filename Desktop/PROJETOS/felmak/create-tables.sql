...
-- 3. Criar tabela para peças utilizadas na OS
...
-- 4. Criar tabela para histórico de comunicações
...
DROP TRIGGER IF EXISTS calculate_total_trigger ON public.ordens_servico;
...
CREATE POLICY "Users can view all ordens_servico" ON public.ordens_servico
  FOR SELECT USING (true);

CREATE POLICY "Users can insert ordens_servico" ON public.ordens_servico
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Users can update ordens_servico" ON public.ordens_servico
  FOR UPDATE USING (true);

CREATE POLICY "Users can view all os_pecas" ON public.os_pecas
  FOR SELECT USING (true);

CREATE POLICY "Users can insert os_pecas" ON public.os_pecas
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Users can update os_pecas" ON public.os_pecas
  FOR UPDATE USING (true);

CREATE POLICY "Users can view all os_comunicacoes" ON public.os_comunicacoes
  FOR SELECT USING (true);

CREATE POLICY "Users can insert os_comunicacoes" ON public.os_comunicacoes
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Users can update os_comunicacoes" ON public.os_comunicacoes
  FOR UPDATE USING (true);
